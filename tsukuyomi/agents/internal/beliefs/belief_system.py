"""
Belief System - Core Class
==========================

Core BeliefSystem class for managing agent beliefs with confidence levels,
evidence-based updates, and contradiction detection.
"""
...
class BeliefSystem:
    ...
    def __init__(
        ...
        self._belief_by_statement: Dict[str, str] = {}
        self._belief_by_tag: Dict[str, Set[str]] = {}
    ...
    def update_belief(
        ...
        if old_confidence > ENTRENCHED_THRESHOLD:
            ...
            change_dampener = 1.0 - (resistance * 0.8)
        else:
            change_dampener = 1.0
        
        if old_confidence > 0.5:
        ...
        evidence_weight = self.openness * 0.5
        ...
        max_change = 0.3 * self.openness * change_dampener
    ...
    def evaluate_evidence(
        ...
        influence_multiplier = influence_weight * 1.5
    ...
    def format_beliefs(self, topics: Optional[List[str]] = None) -> str:
        ...
        if topics:
            ...
            beliefs = list({b.id: b for b in beliefs}.values())
        else:
