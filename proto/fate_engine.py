...
class FateEngine:
    ...
    def __init__(
        ...
        if not hasattr(self, "world_state") or not self.world_state.locations:
            ...
            self.world_state.locations["market_square"].CopyFrom(
                core_pb2.Location(
                    name="market_square", position=common_pb2.Vector2(x=0, y=0)
                )
            )
            self.world_state.locations["tavern"].CopyFrom(
                core_pb2.Location(name="tavern", position=common_pb2.Vector2(x=10, y=5))
            )
            self.world_state.locations["inn"].CopyFrom(
                core_pb2.Location(name="inn", position=common_pb2.Vector2(x=5, y=20))
            )
            self.world_state.locations["well"].CopyFrom(
                core_pb2.Location(name="well", position=common_pb2.Vector2(x=10, y=10))
            )

            # Initialize default objects
            self.world_state.objects["well_structure"].CopyFrom(
            ...
            self.world_state.objects["tavern_bench"].CopyFrom(
                core_pb2.EnvironmentObject(
                    id="tavern_bench",
                    type="furniture",
            ...
            self.world_state.objects["apple_market"].CopyFrom(
                core_pb2.EnvironmentObject(
                    id="apple_market",
                    type="food",
            ...
            self.world_state.objects["hammer_tool"].CopyFrom(
                core_pb2.EnvironmentObject(
                    id="hammer_tool",
                    type="tool",
                    position=common_pb2.Vector2(x=10.5, y=5.5),
                    ...
                    properties={
                        "durability": "100",
                        "description": "A sturdy hammer for repairs.",
                    },
                )
            )
            self.world_state.objects["chest_wood"].CopyFrom(
                core_pb2.EnvironmentObject(
                    id="chest_wood",
                    type="container",
